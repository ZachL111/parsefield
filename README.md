...
parsefield is a Haskell project for parsers. It focuses on this technical goal: Build parser combinators with labels, alternatives, and expression examples.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 182, risk penalty 6, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.

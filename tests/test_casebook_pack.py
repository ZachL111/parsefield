"""Regression checks for the parsefield casebook."""
...
from casebook.harness import assert_expected, parsefield_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parsefield_summary(), assert_expected())
